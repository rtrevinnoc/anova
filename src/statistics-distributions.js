...
export function chisqrdistr(n, p) {
...
export default function fdistr(n, m, p) {
	if ((n <= 0) || ((Math.abs(n) - (Math.abs(integer(n)))) != 0)) {
...
export function uprob(x) {
	return precision_string(_subuprob(x - 0));
}

export function chisqrprob(n, x) {
	if ((n <= 0) || ((Math.abs(n) - (Math.abs(integer(n)))) != 0)) {
		throw ("Invalid n: n\n"); /* degree of freedom */
	}
...
export function _subfprob(n, m, x) {
	var p;
...
export function _subchisqrprob(n, x) {
	var p;
...
export function _subchisqr(n, p) {
	var x;
...
export function precision_string(x) {
	if (x) {
...
export function round_to_precision(x, p) {
	x = x * Math.pow(10, p);
	x = Math.round(x);
